...
<%@page import="co.com.tienda.mascotas.Clientes"%>
...
<title>Tienda Mascotas | Clientes</title>
		...
		<div class="collapse navbar-collapse" id="navbar-list">
			<div class="navbar-nav">
				<a  class="nav-item nav-link active"
					href="Controlador?menu=Clientes&accion=Listar">Clientes</a> 
			</div>
		</div>
	</nav>
	<div class="m-5">
		<div class="row">
			<div class="col-4">
				<div class="card" style="width: 90%; margin: auto;">
					<div class="card-header bg-light" >Clientes</div>
					<div class="card-body">
								...
								<div class="row">
									<div class="col-12">
										...
										<input autocomplete="off" class="form-control" type="text"
											name="txt_cedulac" placeholder="Cédula" value="${clienteSeleccionado.getCedula_cliente()}" required> 
											<label>Nombre Cliente</label>
										    <input autocomplete="off" class="form-control" type="text" name="txt_nombrec"
										     placeholder="Nombre cliente" value="${clienteSeleccionado.getNombre_cliente()}">
											<label>Correo</label>
										    <input autocomplete="off" class="form-control" type="email" name="txt_correoc"
											 placeholder="Correo" value="${clienteSeleccionado.getEmail_cliente()}"> 
											<label>Direccion</label>
											 <input autocomplete="off" class="form-control" type="text" name="txt_direccionc" 
											placeholder="Direccion" value="${clienteSeleccionado.getDireccion_cliente()}"> 
										  <label>Telefono</label>
										<input name="txt_telefonoc" autocomplete="off" class="form-control" type="text" placeholder="telefono" value="${clienteSeleccionado.getTelefono_cliente()}">
