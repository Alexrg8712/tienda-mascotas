								...
								<div class="row">
									<div class="col-12">
										...
										<input autocomplete="off" class="form-control" type="text"
											name="txt_cedula" placeholder="Cédula" value="${usuarioSeleccionado.getCedula_usuario()}" required> <label>Nombre
										...
										<input autocomplete="off" class="form-control" type="text"
											name="txt_usuario" placeholder="Usuario" value="${usuarioSeleccionado.getUsuario()}"> <label>Contraseña</label>
										<input name="txt_password" autocomplete="off"
											class="form-control" type="password" placeholder="Contraseña" value="${usuarioSeleccionado.getPassword()}">
